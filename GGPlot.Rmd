...
fill_empty <- rep(as.factor(c("fill","empty")),2)#by putting 2 at the end it repeats the factor 
estimate <- rep(as.factor(c("Wide Base","Wide Top")),2)#by putting 2 at the end it repeats the factor 2 times
...
ggplot(plot_df, aes(x=fill_empty,y=dv_means,
                    group=estimate,
                    color=estimate,
                    fill=estimate))+#fills inside the bar
...
ggplot(plot_df, aes(x=factor_one,y=dv_means,
                    ...
                    color=factor_two,
                    fill=factor_two))+#fills inside the bar
  geom_bar(stat = "dodge")#dodge means side by side bars
